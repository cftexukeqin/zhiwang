...
Index.prototype.ListenSearchEvent = function(){
    ...
    var searchIdSelect = $("select[name='search-cat-id']");
    var wordsInput = $("input[name='words']");
    searchBtn.click(function (event) {
        searchId = searchIdSelect.val();
        words = wordsInput.val();
        xfzajax.get({
            'url':'/search/',
            'data':{
                'searchtype':searchId,
...
Index.prototype.ListenBackBtn = function(){
    var backBtn = $("#back");
    var simpleBox = $('#simple-box');
    var upperBox = $(".upper-box");
